<ul class="nav navbar-nav">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu" role="menu">
            ...
            <li><?php echo $this->Html->link(__('New Training'), array('plugin' => 'training_manager', 'controller' => 'Trainings', 'action' => 'add')); ?></li>
            <li><?php echo $this->Html->link(__('List Training'), array('plugin' => 'training_manager', 'controller' => 'Trainings', 'action' => 'index')); ?></li>
        </ul>
    </li>
</ul>