<div class="trainingUsers form">
    ...
    <fieldset>
        <legend><?php echo __('Edit Training User'); ?></legend>
        <?php
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TrainingUser.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('TrainingUser.id'))); ?></li>
