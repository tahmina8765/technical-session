<div class="trainingUsers index">
    <h2><?php echo __('Training Users'); ?></h2>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($trainingUsers as $trainingUser): ?>
                <tr>
                    <td><?php echo h($trainingUser['TrainingUser']['id']); ?>&nbsp;</td>
                    <td>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), array('action' => 'view', $trainingUser['TrainingUser']['id'])); ?>
                        <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $trainingUser['TrainingUser']['id'])); ?>
                        <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $trainingUser['TrainingUser']['id']), array(), __('Are you sure you want to delete # %s?', $trainingUser['TrainingUser']['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
